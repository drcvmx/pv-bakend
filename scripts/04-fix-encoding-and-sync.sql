-- Script to fix encoding issues and sync local products
-- Date: 2025-11-25

-- 1. Set Client Encoding to UTF8 to ensure characters are interpreted correctly
SET client_encoding = 'UTF8';

-- 2. Re-populate Global Catalog with correct encoding (Upsert)
...
-- 3. Sync Local Products with Global Products
...
-- 4. Verification
SELECT nombre FROM public.global_products WHERE nombre LIKE '%Limón%';
