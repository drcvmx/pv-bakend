-- =====================================================
-- POBLAR PRODUCTOS EN TENANTS DESDE CATÁLOGO GLOBAL
-- =====================================================
-- Fecha: 2025-11-29
-- Propósito: Agregar 20 productos a cada tenant (Abarrotes y Ferretería)
-- =====================================================

-- =====================================================
-- TENANT 1: TIENDA DON JOSE (Abarrotes)
-- =====================================================
-- ID: a1b2c3d4-e5f6-7890-1234-567890abcdef

DO $$
DECLARE
    v_tenant_id UUID := 'a1b2c3d4-e5f6-7890-1234-567890abcdef';
...
BEGIN
    ...
    -- Producto 1: Papas Fritas Sal de Mar
    SELECT * INTO v_global_product FROM global_products WHERE codigo_barras = '7501000264049';
    IF FOUND THEN
        ...
        VALUES (v_tenant_id, v_producto_id, 'Estándar', 18.00, 'pza', '7501000264049');
        v_contador := v_contador + 1;
    END IF;
    
    -- Producto 2: Papas Fritas Fuego
    SELECT * INTO v_global_product FROM global_products WHERE codigo_barras = '7500810024546';
    IF FOUND THEN
        INSERT INTO productos (tenant_id, global_product_id, nombre, descripcion, marca, categoria, codigo_barras, imagen_url)
        VALUES (v_tenant_id, v_global_product.id, v_global_product.nombre, v_global_product.descripcion, 
                v_global_product.marca, v_global_product.categoria, v_global_product.codigo_barras, v_global_product.imagen_url)
        ...
        INSERT INTO variantes (tenant_id, producto_id, nombre_variante, precio, unidad_medida, codigo_barras)
        VALUES (v_tenant_id, v_producto_id, 'Estándar', 19.50, 'pza', '7500810024546');
        v_contador := v_contador + 1;
    END IF;
    
    -- Producto 3: Papas Fritas Adobadas
    SELECT * INTO v_global_product FROM global_products WHERE codigo_barras = '7503028643745';
    IF FOUND THEN
        INSERT INTO productos (tenant_id, global_product_id, nombre, descripcion, marca, categoria, codigo_barras, imagen_url)
        VALUES (v_tenant_id, v_global_product.id, v_global_product.nombre, v_global_product.descripcion, 
                v_global_product.marca, v_global_product.categoria, v_global_product.codigo_barras, v_global_product.imagen_url)
        ...
        INSERT INTO variantes (tenant_id, producto_id, nombre_variante, precio, unidad_medida, codigo_barras)
        VALUES (v_tenant_id, v_producto_id, 'Estándar', 18.00, 'pza', '7503028643745');
        v_contador := v_contador + 1;
    END IF;
    
    -- Producto 4: Papas Fritas Jalapeño
    SELECT * INTO v_global_product FROM global_products WHERE codigo_barras = '7501000264773';
    IF FOUND THEN
        INSERT INTO productos (tenant_id, global_product_id, nombre, descripcion, marca, categoria, codigo_barras, imagen_url)
        VALUES (v_tenant_id, v_global_product.id, v_global_product.nombre, v_global_product.descripcion, 
                v_global_product.marca, v_global_product.categoria, v_global_product.codigo_barras, v_global_product.imagen_url)
        ...
        INSERT INTO variantes (tenant_id, producto_id, nombre_variante, precio, unidad_medida, codigo_barras)
        VALUES (v_tenant_id, v_producto_id, 'Estándar', 19.50, 'pza', '7501000264773');
        v_contador := v_contador + 1;
    END IF;
    
    -- Producto 5: Takis Fuego
    SELECT * INTO v_global_product FROM global_products WHERE codigo_barras = '7501030424536';
    IF FOUND THEN
        INSERT INTO productos (tenant_id, global_product_id, nombre, descripcion, marca, categoria, codigo_barras, imagen_url)
        VALUES (v_tenant_id, v_global_product.id, v_global_product.nombre, v_global_product.descripcion, 
                v_global_product.marca, v_global_product.categoria, v_global_product.codigo_barras, v_global_product.imagen_url)
        ...
        INSERT INTO variantes (tenant_id, producto_id, nombre_variante, precio, unidad_medida, codigo_barras)
        VALUES (v_tenant_id, v_producto_id, 'Estándar', 21.00, 'pza', '7501030424536');
        v_contador := v_contador + 1;
    END IF;
    
    -- Producto 6: Takis Original
    SELECT * INTO v_global_product FROM global_products WHERE codigo_barras = '7501000164370';
    IF FOUND THEN
        INSERT INTO productos (tenant_id, global_product_id, nombre, descripcion, marca, categoria, codigo_barras, imagen_url)
        VALUES (v_tenant_id, v_global_product.id, v_global_product.nombre, v_global_product.descripcion, 
                v_global_product.marca, v_global_product.categoria, v_global_product.codigo_barras, v_global_product.imagen_url)
        ...
        INSERT INTO variantes (tenant_id, producto_id, nombre_variante, precio, unidad_medida, codigo_barras)
        VALUES (v_tenant_id, v_producto_id, 'Estándar', 20.00, 'pza', '7501000164370');
        v_contador := v_contador + 1;
    END IF;
    
    -- Producto 7: Takis Huakamoles
    SELECT * INTO v_global_product FROM global_products WHERE codigo_barras = '7501000148288';
    IF FOUND THEN
        INSERT INTO productos (tenant_id, global_product_id, nombre, descripcion, marca, categoria, codigo_barras, imagen_url)
        VALUES (v_tenant_id, v_global_product.id, v_global_product.nombre, v_global_product.descripcion, 
                v_global_product.marca, v_global_product.categoria, v_global_product.codigo_barras, v_global_product.imagen_url)
        ...
        INSERT INTO variantes (tenant_id, producto_id, nombre_variante, precio, unidad_medida, codigo_barras)
        VALUES (v_tenant_id, v_producto_id, 'Estándar', 22.00, 'pza', '7501000148288');
        v_contador := v_contador + 1;
    END IF;
    
    -- Producto 8: Cacahuates Salados
    SELECT * INTO v_global_product FROM global_products WHERE codigo_barras = '7501000164804';
    IF FOUND THEN
        INSERT INTO productos (tenant_id, global_product_id, nombre, descripcion, marca, categoria, codigo_barras, imagen_url)
        VALUES (v_tenant_id, v_global_product.id, v_global_product.nombre, v_global_product.descripcion, 
                v_global_product.marca, v_global_product.categoria, v_global_product.codigo_barras, v_global_product.imagen_url)
        ...
        INSERT INTO variantes (tenant_id, producto_id, nombre_variante, precio, unidad_medida, codigo_barras)
        VALUES (v_tenant_id, v_producto_id, 'Estándar', 17.00, 'pza', '7501000164804');
        v_contador := v_contador + 1;
    END IF;
    
    -- Producto 9: Cacahuates Japonés
    SELECT * INTO v_global_product FROM global_products WHERE codigo_barras = '7501000164880';
    IF FOUND THEN
        INSERT INTO productos (tenant_id, global_product_id, nombre, descripcion, marca, categoria, codigo_barras, imagen_url)
        VALUES (v_tenant_id, v_global_product.id, v_global_product.nombre, v_global_product.descripcion, 
                v_global_product.marca, v_global_product.categoria, v_global_product.codigo_barras, v_global_product.imagen_url)
        ...
        INSERT INTO variantes (tenant_id, producto_id, nombre_variante, precio, unidad_medida, codigo_barras)
        VALUES (v_tenant_id, v_producto_id, 'Estándar', 25.00, 'pza', '7501000164880');
        v_contador := v_contador + 1;
    END IF;
    
    -- Producto 10: Pepitas Saladas
    SELECT * INTO v_global_product FROM global_products WHERE codigo_barras = '7501000164828';
    IF FOUND THEN
        INSERT INTO productos (tenant_id, global_product_id, nombre, descripcion, marca, categoria, codigo_barras, imagen_url)
        VALUES (v_tenant_id, v_global_product.id, v_global_product.nombre, v_global_product.descripcion, 
                v_global_product.marca, v_global_product.categoria, v_global_product.codigo_barras, v_global_product.imagen_url)
        ...
        INSERT INTO variantes (tenant_id, producto_id, nombre_variante, precio, unidad_medida, codigo_barras)
        VALUES (v_tenant_id, v_producto_id, 'Estándar', 14.00, 'pza', '7501000164828');
        v_contador := v_contador + 1;
    END IF;
    
    -- Producto 11: Botana Surtida Queso
    SELECT * INTO v_global_product FROM global_products WHERE codigo_barras = '7501000192531';
    IF FOUND THEN
        INSERT INTO productos (tenant_id, global_product_id, nombre, descripcion, marca, categoria, codigo_barras, imagen_url)
        VALUES (v_tenant_id, v_global_product.id, v_global_product.nombre, v_global_product.descripcion, 
                v_global_product.marca, v_global_product.categoria, v_global_product.codigo_barras, v_global_product.imagen_url)
        ...
        INSERT INTO variantes (tenant_id, producto_id, nombre_variante, precio, unidad_medida, codigo_barras)
        VALUES (v_tenant_id, v_producto_id, 'Estándar', 24.00, 'pza', '7501000192531');
        v_contador := v_contador + 1;
    END IF;
    
    -- Producto 12: Botana Surtida Clásico
    SELECT * INTO v_global_product FROM global_products WHERE codigo_barras = '7501000167690';
    IF FOUND THEN
        INSERT INTO productos (tenant_id, global_product_id, nombre, descripcion, marca, categoria, codigo_barras, imagen_url)
        VALUES (v_tenant_id, v_global_product.id, v_global_product.nombre, v_global_product.descripcion, 
                v_global_product.marca, v_global_product.categoria, v_global_product.codigo_barras, v_global_product.imagen_url)
        ...
        INSERT INTO variantes (tenant_id, producto_id, nombre_variante, precio, unidad_medida, codigo_barras)
        VALUES (v_tenant_id, v_producto_id, 'Estándar', 24.00, 'pza', '7501000167690');
        v_contador := v_contador + 1;
    END IF;
    
    -- Producto 13: Botana Surtida Fuego
    SELECT * INTO v_global_product FROM global_products WHERE codigo_barras = '7501000192463';
    IF FOUND THEN
        INSERT INTO productos (tenant_id, global_product_id, nombre, descripcion, marca, categoria, codigo_barras, imagen_url)
        VALUES (v_tenant_id, v_global_product.id, v_global_product.nombre, v_global_product.descripcion, 
                v_global_product.marca, v_global_product.categoria, v_global_product.codigo_barras, v_global_product.imagen_url)
        ...
        INSERT INTO variantes (tenant_id, producto_id, nombre_variante, precio, unidad_medida, codigo_barras)
        VALUES (v_tenant_id, v_producto_id, 'Estándar', 25.50, 'pza', '7501000192463');
        v_contador := v_contador + 1;
    END IF;
    
    -- Producto 14: Botana Surtida Party
    SELECT * INTO v_global_product FROM global_products WHERE codigo_barras = '7501000167676';
    IF FOUND THEN
        INSERT INTO productos (tenant_id, global_product_id, nombre, descripcion, marca, categoria, codigo_barras, imagen_url)
        VALUES (v_tenant_id, v_global_product.id, v_global_product.nombre, v_global_product.descripcion, 
                v_global_product.marca, v_global_product.categoria, v_global_product.codigo_barras, v_global_product.imagen_url)
        ...
        INSERT INTO variantes (tenant_id, producto_id, nombre_variante, precio, unidad_medida, codigo_barras)
        VALUES (v_tenant_id, v_producto_id, 'Estándar', 29.00, 'pza', '7501000167676');
        v_contador := v_contador + 1;
    END IF;
    
    -- Producto 15: Cheetos Bolitas
    SELECT * INTO v_global_product FROM global_products WHERE codigo_barras = '7500478015047';
    IF FOUND THEN
        INSERT INTO productos (tenant_id, global_product_id, nombre, descripcion, marca, categoria, codigo_barras, imagen_url)
        VALUES (v_tenant_id, v_global_product.id, v_global_product.nombre, v_global_product.descripcion, 
                v_global_product.marca, v_global_product.categoria, v_global_product.codigo_barras, v_global_product.imagen_url)
        ...
        INSERT INTO variantes (tenant_id, producto_id, nombre_variante, precio, unidad_medida, codigo_barras)
        VALUES (v_tenant_id, v_producto_id, 'Estándar', 18.00, 'pza', '7500478015047');
        v_contador := v_contador + 1;
    END IF;
    
    -- Producto 16: Cheetos Poffs
    SELECT * INTO v_global_product FROM global_products WHERE codigo_barras = '7500478014606';
    IF FOUND THEN
        INSERT INTO productos (tenant_id, global_product_id, nombre, descripcion, marca, categoria, codigo_barras, imagen_url)
        VALUES (v_tenant_id, v_global_product.id, v_global_product.nombre, v_global_product.descripcion, 
                v_global_product.marca, v_global_product.categoria, v_global_product.codigo_barras, v_global_product.imagen_url)
        ...
        INSERT INTO variantes (tenant_id, producto_id, nombre_variante, precio, unidad_medida, codigo_barras)
        VALUES (v_tenant_id, v_producto_id, 'Estándar', 17.00, 'pza', '7500478014606');
        v_contador := v_contador + 1;
    END IF;
    
    -- Producto 17: Cheetos Flamin Hot
    SELECT * INTO v_global_product FROM global_products WHERE codigo_barras = '7501011143753';
    IF FOUND THEN
        INSERT INTO productos (tenant_id, global_product_id, nombre, descripcion, marca, categoria, codigo_barras, imagen_url)
        VALUES (v_tenant_id, v_global_product.id, v_global_product.nombre, v_global_product.descripcion, 
                v_global_product.marca, v_global_product.categoria, v_global_product.codigo_barras, v_global_product.imagen_url)
        ...
        INSERT INTO variantes (tenant_id, producto_id, nombre_variante, precio, unidad_medida, codigo_barras)
        VALUES (v_tenant_id, v_producto_id, 'Estándar', 20.00, 'pza', '7501011143753');
        v_contador := v_contador + 1;
    END IF;
    
    -- Producto 18: Tostitos Salsa Verde
    SELECT * INTO v_global_product FROM global_products WHERE codigo_barras = '7501011127012';
    IF FOUND THEN
        INSERT INTO productos (tenant_id, global_product_id, nombre, descripcion, marca, categoria, codigo_barras, imagen_url)
        VALUES (v_tenant_id, v_global_product.id, v_global_product.nombre, v_global_product.descripcion, 
                v_global_product.marca, v_global_product.categoria, v_global_product.codigo_barras, v_global_product.imagen_url)
        ...
        INSERT INTO variantes (tenant_id, producto_id, nombre_variante, precio, unidad_medida, codigo_barras)
        VALUES (v_tenant_id, v_producto_id, 'Estándar', 21.00, 'pza', '7501011127012');
        v_contador := v_contador + 1;
    END IF;
    
    -- Producto 19: Tostitos Dip Queso Jalapeño
    SELECT * INTO v_global_product FROM global_products WHERE codigo_barras = '7501011194465';
    IF FOUND THEN
        INSERT INTO productos (tenant_id, global_product_id, nombre, descripcion, marca, categoria, codigo_barras, imagen_url)
        VALUES (v_tenant_id, v_global_product.id, v_global_product.nombre, v_global_product.descripcion, 
                v_global_product.marca, v_global_product.categoria, v_global_product.codigo_barras, v_global_product.imagen_url)
        ...
        INSERT INTO variantes (tenant_id, producto_id, nombre_variante, precio, unidad_medida, codigo_barras)
        VALUES (v_tenant_id, v_producto_id, 'Estándar', 38.00, 'pza', '7501011194465');
        v_contador := v_contador + 1;
    END IF;
    
    -- Producto 20: Coca-Cola 3L
    SELECT * INTO v_global_product FROM global_products WHERE codigo_barras = '7501055301824';
    IF FOUND THEN
        INSERT INTO productos (tenant_id, global_product_id, nombre, descripcion, marca, categoria, codigo_barras, imagen_url)
        VALUES (v_tenant_id, v_global_product.id, v_global_product.nombre, v_global_product.descripcion, 
                v_global_product.marca, v_global_product.categoria, v_global_product.codigo_barras, v_global_product.imagen_url)
        ...
        INSERT INTO variantes (tenant_id, producto_id, nombre_variante, precio, unidad_medida, codigo_barras)
        VALUES (v_tenant_id, v_producto_id, 'Estándar', 45.00, 'pza', '7501055301824');
        v_contador := v_contador + 1;
    END IF;
    
    RAISE NOTICE 'Productos agregados a Tienda Don Jose: %', v_contador;
END $$;

-- =====================================================
-- TENANT 2: FERRETERÍA EL TORNILLO (Ferretería)
-- =====================================================
